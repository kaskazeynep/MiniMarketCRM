...
namespace MiniMarketCRM.Application.Services
{
    public class SiparisService : ISiparisService
    {
        ...
        {
            return await _db.Siparisler.AsNoTracking()
        ...
        public async Task<SiparisDTO?> UpdateAsync(int id, SiparisUpsertDTO dto)
        {
            ...
            // ToplamTutar: kalemlerden hesaplanacak, client’tan geleni yok say
        ...
        {
            // Siparişi kalemleriyle çek (iptal edilen siparişlerin stoklarını geri yükseltmek için)
